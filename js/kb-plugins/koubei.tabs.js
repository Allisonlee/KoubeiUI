/*! 口碑插件&TAB菜单 v0.0.1 ~ (c) 2016-2016 @快叫我韩大人 ~ http://weibo.com/hoythan */
	...
	KouBeiTabs.prototype = {
		...
		_Bind:function(el){
			...
			$(el).on('click', 'li.kb-tabs-li', function() {
				...
				// 隐藏滚动条
				$('body').addClass('kb-hide-scroll-x');
		...
		_HideEleClass:function(el_index){
			...
			$('body').removeClass('kb-hide-scroll-x');
		},
